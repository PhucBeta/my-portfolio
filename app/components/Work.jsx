    ...
    return (
        <motion.div
            ...
            <motion.h4
                ...
                className='text-center mb-2 text-lg font-ovo'>{t.portfolio}</motion.h4>
            <motion.h2
                initial={{ opacity: 0, y: -20 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            <motion.div
                ...
                {getWorkData(language).map((project, index) => (
                    <motion.div
            ...
            <motion.a
                ...
                {t.showMore} <Image src={isDarkMode ? assets.right_arrow_bold_dark : assets.right_arrow_bold} alt='Right arrow' className='w-4 ' />
            </motion.a>
